...
25.times do
	...
	fullfillment_fee: Faker::Commerce.price(range: 0..2.99),
...
5000.times do
	...
	shipped_at = %[shipped delivered].include?(order_type) ? purchase_date + 3.days : nil
	estimated_arrival_date = shipped_at.present? ? shipped_at + 4.days : nil
	confirmed_at = purchase_date - 1.hour
	fullfillment_center = %w[5bs yg1 mej xqf 4wj].sample
