...
ActiveRecord::Schema[7.1].define(version: 2025_05_20_095845) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.integer "inventory"
    t.float "fullfillment_fee", default: 0.0
  ...
  create_table "resources", force: :cascade do |t|
    ...
    t.index ["purchase_order_id"], name: "index_resources_on_purchase_order_id"
  end

  add_foreign_key "order_items", "items"
  add_foreign_key "order_items", "purchase_orders"
  add_foreign_key "resources", "items"
  add_foreign_key "resources", "purchase_orders"
end
